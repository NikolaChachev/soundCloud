...
VALUES('kiko','kiki123',1,'asdprofilePicture/ManProfile.png',"kiko97@abv.bg",'sandanski','bulgaria','kiril','krastavicata');

INSERT INTO users(username,password,user_type,profile_picture,email,city_name,country,first_name,second_name) 
VALUES('bobenceto','bobi97',1,'asdprofilePicture/ManProfile.png',"borimechka@abv.bg",'sandanski','bulgaria','borislav','boreca');

INSERT INTO users(username,password,user_type,profile_picture,email,city_name,country,first_name,second_name) 
VALUES('hrissiee','hrissiee123',1,'asdprofilePicture/WomanProfile.png',"hrissiee@abv.bg",'sofia','bulgaria','hristiana','narcisa');

INSERT INTO users(username,password,user_type,profile_picture,email,city_name,country,first_name,second_name) 
VALUES('muse','theRealMuse',3,'asdprofilePicture/ManProfile.png',"officialMuse@gmail.com",'somewhere','Great Britain','','');

INSERT INTO users(username,password,user_type,profile_picture,email,city_name,country,first_name,second_name) 
VALUES('epica','alwaysEpic',3,'asdprofilePicture/ManProfile.png',"officialEpica@gmail.com",'stockholm','sweden','','');

INSERT INTO users(username,password,user_type,profile_picture,email,city_name,country,first_name,second_name) 
VALUES('lady gaga','gagaulala',3,'asdprofilePicture/crazyPic.png',"gagaga@gmail.com",'new york','USA','stefani','germanotta');

INSERT INTO users(username,password,user_type,profile_picture,email,city_name,country,first_name,second_name) 
VALUES('crazyDude99','leVski4life',2,'asdprofilePicture/ManProfile.png',"levskieVarha@abv.bg",'sofia','bulgaria','ivan','krastev');

INSERT INTO users(username,password,user_type,profile_picture,email,city_name,country,first_name,second_name) 
VALUES('cvetencetoouu','tsvetito123',2,'asdprofilePicture/WomanPic.png',"cvetenceto97@abv.bg",'sandanski','bulgaria','tsvetelina','goreplaninska');

INSERT INTO users(username,password,user_type,profile_picture,email,city_name,country,first_name,second_name) 
VALUES('chihlala','stelchencetu99',2,'asdprofilePicture/WomanPic.png',"stelaPastela99@gmail.com",'rome','italy','stela','gotinata');
